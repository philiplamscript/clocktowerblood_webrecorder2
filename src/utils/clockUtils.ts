export const getPosition = (num: number, playerCount: number, radius: number, cx: number = 144, cy: number = 144) => {
...
export const getSlicePath = (index: number, total: number, rInner: number, rOuter: number, cx: number = 144, cy: number = 144) => {
