  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      >
        ...
        {pendingNom && !isVoting && <ClockArrow from={parseInt(pendingNom.f)} to={parseInt(pendingNom.t)} day={ringCount} type={pendingNom.f === pendingNom.t ? 'self' : 'to'} playerCount={playerCount} innerRadius={innerRadius} ringWidth={ringWidth} width={3} />}
