  ...
  return (
    <div className="bg-[var(--panel-color)] rounded border border-[var(--border-color)] shadow-sm transition-colors duration-500">
      <div className="bg-[var(--header-color)] px-3 py-1.5 flex items-center gap-2">
        ...
        <span className="text-[var(--text-on-header)] text-[9px] font-black uppercase tracking-widest">Death Ledger</span>
      </div>
      <table className="w-full border-collapse table-fixed">
        <thead>
          <tr className="bg-[var(--bg-color)] border-b border-[var(--border-color)] text-[8px] uppercase text-[var(--muted-color)] font-black transition-colors duration-500">
            <th className="w-8 py-2 border-r border-[var(--border-color)] text-center">
              <div className="flex flex-col items-center text-[var(--text-on-bg)]"><Calendar size={10} /></div>
            </th>
            <th className="w-12 py-2 border-r border-[var(--border-color)] text-center">
              <div className="flex flex-col items-center text-[var(--text-on-bg)]"><Target size={10} /></div>
            </th>
            <th className="w-12 py-2 border-r border-[var(--border-color)] text-center">
              <div className="flex flex-col items-center text-[var(--text-on-bg)]"><Zap size={10} /></div>
            </th>
            <th className="py-2 px-3 text-left text-[var(--text-on-bg)]">NOTES</th>
        ...
        <tbody className="divide-y divide-[var(--border-color)] text-[var(--text-on-panel)]">
          {deaths.map((d: Death) => (
            <tr key={d.id} className="h-10 hover:bg-black/5 transition-colors">
              <td className="p-0 border-r border-[var(--border-color)]">
                <input 
                  type="number" 
                  className="w-full text-center border-none bg-transparent focus:ring-0 text-[10px] font-black p-0 text-[var(--text-on-panel)]" 
                  value={d.day} 
              ...
              <td className="p-0 px-2 font-mono">
                <input 
                  placeholder="..." 
                  className="w-full border-none bg-transparent focus:ring-0 text-[10px] h-10 text-[var(--text-on-panel)]" 
                  value={d.note} 
