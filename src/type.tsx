...
export const THEMES: Record<Exclude<ThemeType, string>, Theme> = {
  ...
  crino: {
    ...
    patterns: {
      ...
      bg: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='40 30 165 330' width='150' height='150'>
      <defs><linearGradient id='crystalGrad' x1='0%' y1='0%' x2='100%' y2='100%'>
      <stop offset='0%' style='stop-color:#00E5FF;stop-opacity:0.4' />
      <stop offset='50%' style='stop-color:#3498DB;stop-opacity:0.2' /><stop offset='100%' style='stop-color:#0B1D2A;stop-opacity:0.1' /></linearGradient>   
      // <symbol id='crystal-shard' viewBox='0 0 160 60'><path d='M10,30 L80,5 L150,30 L80,55 Z' fill='url(#crystalGrad)' stroke='#00c8e2' stroke-width='1'/>
      // <path d='M10,30 L150,30' stroke='#FFFFFF' stroke-width='1' opacity='0.3'/><path d='M80,5 L80,55' stroke='#FFFFFF' stroke-width='1' opacity='0.2'/>
      // <path d='M40,15 L60,30 L40,45' fill='none' stroke='#FFFFFF' stroke-width='0.8' opacity='0.3'/>
      // <path d='M120,15 L100,30 L120,45' fill='none' stroke='#FFFFFF' stroke-width='0.8' opacity='0.3'/>
      // <path d='M80,5 L110,30 L80,55 L50,30 Z' fill='none' stroke='#00E5FF' stroke-width='0.5' opacity='0.2'/>
      // <polygon points='80,5 95,15 80,18' fill='white' opacity='0.3' /> <polygon points='30,25 50,30 35,35' fill='white' opacity='0.2' /></symbol>
...
<defs>
  ...
  <defs>
    <g id="arm">
      <path fill="#22b4f8" d="M256,210 V20 C256,15 260,15 260,20 V210 Z" />
      <path fill="#ffffff" d="M256,100 L220,64 M256,100 L292,64" stroke="#00daf7" stroke-width="8" stroke-linecap="round"/>
      <path fill="#ffffff" d="M256,160 L230,134 M256,160 L282,134" stroke="#00daf7" stroke-width="8" stroke-linecap="round"/>
    </g>
  </defs>

  <circle cx="256" cy="256" r="40" fill="#ffffff" />

  <use xlink:href="#arm" transform="rotate(0 256 256)" />
  <use xlink:href="#arm" transform="rotate(45 256 256)" />
  <use xlink:href="#arm" transform="rotate(90 256 256)" />
  <use xlink:href="#arm" transform="rotate(135 256 256)" />
  <use xlink:href="#arm" transform="rotate(180 256 256)" />
  <use xlink:href="#arm" transform="rotate(225 256 256)" />
  <use xlink:href="#arm" transform="rotate(270 256 256)" />
  <use xlink:href="#arm" transform="rotate(315 256 256)" />
